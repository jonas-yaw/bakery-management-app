                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-6">
                                          <div class="form-label-group">
                                            <input type="text" rows="3" class="form-control" placeholder="Role Name"  id="role_name" name="role_name" value="{{ $role->name }}">         
                                      ...
                                      <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                          <input type="text" placeholder="Description" rows="3" class="form-control" required="true" id="role_description" name="role_description" value="{{ $role->description }}">      

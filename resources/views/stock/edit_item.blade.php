                    ...
                    <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="row">
                                  <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label for="item_name">Barcode</label>
                                ...
                                <div class="col-md-6 col-6">
                                  <div class="form-group">
                                    ...
                                    <select id="edit_item_category" name="item_category" required rows="3" data-required="true" tabindex="1" data-placeholder="Select here.." class="form-control m-b"  style="width: 100%;">
                              ...
                              <div class="col-md-6 col-6">
                                <div class="form-group">
                                  ...
                                  <select id="edit_item_brand" name="item_brand" rows="3" data-required="true" tabindex="1" data-placeholder="Select here.." class="custom-select2 form-control m-b" style="width: 100%;">
                            ...
                            <div class="col-md-6 col-6">
                              <div class="form-group">
                                ...
                                <select id="edit_item_supplier" name="item_supplier" rows="3" data-required="true" tabindex="1" data-placeholder="Select here.." class="form-control m-b" style="width: 100%;">
